...
for isolate in assembly_dict:
    ...
    for file in input_files:
        ...
        wp_blast_cmd += "-evalue 1e-100 -num_threads 16 -outfmt 5 -max_target_seqs 5 -max_hsps 5"
        ...
        pf_blast_cmd += "-evalue 1e-100 -num_threads 16 -outfmt 5 -max_target_seqs 5 -max_hsps 5"
